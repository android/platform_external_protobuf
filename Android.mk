...
LOCAL_PROTOC_FLAGS := --proto_path=$(LOCAL_PATH)/src --proto_path=$(LOCAL_PATH)/java/src/test/java

LOCAL_PROTO_JAVA_OUTPUT_PARAMS := java_package=google/protobuf/unittest_import_nano.proto|com.google.protobuf.nano,java_outer_classname=google/protobuf/unittest_import_nano.proto|UnittestImportNano
