...
java_use_vector={true,false}:
  ...
  The default value for java_use_vector is false.

java_package=<file-name>|<package-name>:
  This allows setting/overriding the java_package option
  ...
  of this command line option, or the value of the
  java_package option defined in the file, or the proto
  package, or the default Java package, in this order of
  precedence.

java_outer_classname=<file-name>|<outer-classname>:
  This allows the setting/overriding of the
  java_outer_classname option for the given file from the
  command line. Use multiple java_outer_classname options
  to override the option for multiple files. The final
  Java outer class name for each file is the value of this
  command line option, or the value of the
  java_outer_classname option defined in the file, or the
  file name converted to CamelCase, in this order of
  precedence.
...
java_multiple_files={true,false}:
  ...
  the command line. The default is unset, which means the
  code generator should use the java_multiple_files option
  values defined in individual files (where the default is
  false).
...
java_outer_classname=<file-name>|<class-name> (command line)
  ...
  will now always generate the outer class.
